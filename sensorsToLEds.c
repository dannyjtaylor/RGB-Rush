...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Dual Pressure Sensor + Dual RGB LED (Debug Version)
  ******************************************************************************
  */
...
#define THRESH_OFF   200  // Lowered threshold to catch light touches
...
uint16_t Read_ADC1(void) {
    HAL_ADC_Start(&hadc1);
    // Increased timeout to 100ms to prevent timeout errors
